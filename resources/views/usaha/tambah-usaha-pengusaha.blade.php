  ...
  <div class="flex flex-col w-full items-center">
    ...
    <form action="/daftar-usaha/tambah/{{ auth('pengusaha')->user()->id_pemilik_usaha }}" enctype="multipart/form-data"
      ...
      <div class="flex flex-col w-[30rem]">
        ...
        <input type="text" name="nama_usaha" required oninvalid="this.setCustomValidity('Semua data harus diisi')"
      ...
      <div class="flex flex-col w-[30rem]">
        ...
        <input type="text" name="deskripsi" required oninvalid="this.setCustomValidity('Semua data harus diisi')"
          oninput="this.setCustomValidity('')"
      ...
      <div class="flex flex-col w-[30rem]">
        ...
        <input type="number" name="tahun_berdiri" required oninvalid="this.setCustomValidity('Semua data harus diisi')"
          oninput="this.setCustomValidity('')"
          class="px-2 outline-none focus:ring-0 border-2 border-neutral-200 text-neutral-500 focus:text-yellow-500 focus:border-yellow-500 rounded-md py-1 font-medium font-roboto duration-200">
      </div>
      <div class="flex flex-col w-[30rem]">
        <p class="text-neutral-500 font-medium font-roboto mx-2">PERIODE PRODUKSI</p>
        <input type="number" name="periode_produksi" required oninvalid="this.setCustomValidity('Semua data harus diisi')"
          oninput="this.setCustomValidity('')"
          class="px-2 outline-none focus:ring-0 border-2 border-neutral-200 text-neutral-500 focus:text-yellow-500 focus:border-yellow-500 rounded-md py-1 font-medium font-roboto duration-200">
      </div>
      <div class="flex flex-col w-[30rem]">
        <p class="text-neutral-500 font-medium font-roboto mx-2">TARGET DANA</p>
        <input type="number" step="100000" name="target_dana" required oninvalid="this.setCustomValidity('Semua data harus diisi')"
          oninput="this.setCustomValidity('')"
          class="px-2 outline-none focus:ring-0 border-2 border-neutral-200 text-neutral-500 focus:text-yellow-500 focus:border-yellow-500 rounded-md py-1 font-medium font-roboto duration-200">
      </div>
      <div class="flex flex-col w-[30rem]">
