<form action="/profile/edit" method="POST" class="relative grid grid-cols-12 p-4 gap-2 w-[50rem] bg-white rounded-lg shadow-md shadow-black/50">
  ...
  <div class="col-span-6 py-1 flex flex-col text-neutral-500 font-medium font-roboto">
    ...
    <select type="text" name="provinsi" onchange="window.location.assign('{{ url()->current().'?edit=true&provinsi=' }}'+this.value)"
      ...
      @foreach ( $province as $key => $value )
        <option value="{{$value->code}}" {{$value->code == request()->get('provinsi') || $value->code == $detailUser->provinsi ? 'selected' : ''}}>{{$value->name}}</option>
      @endforeach
    </select>
  </div>
  <div class="col-span-6 py-1 flex flex-col text-neutral-500 font-medium font-roboto">
    <p class="text-neutral-700 mx-2">KOTA</p>
    <select type="text" name="provinsi" onchange="window.location.assign('{{ url()->current().'?edit=true&provinsi=' }}' + '{{ request()->get('provinsi') }}' + '&kota=' + this.value)"
      class="outline-none focus:ring-0 border-2 border-neutral-400 px-2 py-[6px] text-lg rounded-md bg-neutral-200/50 focus:text-yellow-500 focus:border-yellow-500 duration-200 focus:bg-yellow-100/25"
      {{ request()->get('edit') != 'true' || empty(request()->get('provinsi')) ? 'disabled' : '' }}>
      @foreach ( $city as $key => $value )
        @if ($value->province_code == request()->get('provinsi'))
          <option value="{{$value->code}}" {{$value->code == request()->get('kota') || $value->code == $detailUser->kota ? 'selected' : ''}}>{{$value->name}}</option>
        @endif
      @endforeach
    </select>
  </div>
  <div class="col-span-6 py-1 flex flex-col text-neutral-500 font-medium font-roboto">
    ...
    <select type="text" name="provinsi" onchange="window.location.assign('{{ url()->current().'?edit=true&provinsi=' }}' + '{{ request()->get('provinsi') }}' + '&kota=' + '{{ request()->get('kota') }}' +  '&kecamatan=' + this.value)"
      class="outline-none focus:ring-0 border-2 border-neutral-400 px-2 py-[6px] text-lg rounded-md bg-neutral-200/50 focus:text-yellow-500 focus:border-yellow-500 duration-200 focus:bg-yellow-100/25"
      {{ request()->get('edit') != 'true' || empty(request()->get('kota')) ? 'disabled' : '' }}>
      @foreach ( $district as $key => $value )
        @if ($value->city_code == request()->get('kota'))
          <option value="{{$value->code}}" {{$value->code == request()->get('kecamatan') || $value->code == $detailUser->kecamatan ? 'selected' : ''}}>{{$value->name}}</option>
        @endif
      @endforeach
    </select>
  </div>
  <div class="col-span-6 py-1 flex flex-col text-neutral-500 font-medium font-roboto">
    ...
    <input type="text" name="alamat_rumah"
      ...
      {{ request()->get('edit') != 'true' ? 'disabled' : '' }} value="{{ !empty($detailUser->alamat_rumah) ? $detailUser->alamat_rumah : null }}">
  </div>
  ...
  <div class="col-span-6 py-1 flex flex-col text-neutral-500 font-medium font-roboto">
    ...
    <input type="text" name="username"
      class="outline-none focus:ring-0 border-2 border-neutral-400 px-2 py-1 text-lg rounded-md bg-neutral-200/50 focus:text-yellow-500 focus:border-yellow-500 duration-200 focus:bg-yellow-100/25"
      {{ request()->get('edit') != 'true' || empty(request()->get('provinsi')) || empty(request()->get('kota')) || empty(request()->get('kecamatan'))  ? 'disabled' : '' }} value="{{ $detailUser->username }}">
  </div>
  <div class="col-span-6 py-1 flex flex-col text-neutral-500 font-medium font-roboto">
    <p class="text-neutral-700 mx-2">EMAIL</p>
    <input type="email" name="email"
      class="outline-none focus:ring-0 border-2 border-neutral-400 px-2 py-1 text-lg rounded-md bg-neutral-200/50 focus:text-yellow-500 focus:border-yellow-500 duration-200 focus:bg-yellow-100/25"
      {{ request()->get('edit') != 'true' || empty(request()->get('provinsi')) || empty(request()->get('kota')) || empty(request()->get('kecamatan'))  ? 'disabled' : '' }} value="{{ $detailUser->email }}">
  </div>
  <div class="col-span-6 py-1 flex flex-col text-neutral-500 font-medium font-roboto">
  ...
  <div class="col-span-6 py-1 flex flex-col text-neutral-500 font-medium font-roboto">
    ...
    <input type="text" name="no_rekening"
      class="outline-none focus:ring-0 border-2 border-neutral-400 px-2 py-1 text-lg rounded-md bg-neutral-200/50 focus:text-yellow-500 focus:border-yellow-500 duration-200 focus:bg-yellow-100/25"
      {{ request()->get('edit') != 'true' || empty(request()->get('provinsi')) || empty(request()->get('kota')) || empty(request()->get('kecamatan'))  ? 'disabled' : '' }} value="{{ !empty($detailUser->no_rekening) ? $detailUser->no_rekening : null }}">
  </div>
  <div class="col-span-6 py-1 flex flex-col text-neutral-500 font-medium font-roboto">
    <p class="text-neutral-700 mx-2">NOMOR HANDPHONE</p>
    <input type="text" name="no_hp"
      class="outline-none focus:ring-0 border-2 border-neutral-400 px-2 py-1 text-lg rounded-md bg-neutral-200/50 focus:text-yellow-500 focus:border-yellow-500 duration-200 focus:bg-yellow-100/25"
      {{ request()->get('edit') != 'true' || empty(request()->get('provinsi')) || empty(request()->get('kota')) || empty(request()->get('kecamatan'))  ? 'disabled' : '' }} value="{{ !empty($detailUser->no_hp) ? $detailUser->no_hp : null }}">
  </div>
  <div class="col-span-6 py-1 flex flex-col text-neutral-500 font-medium font-roboto">
    <p class="text-neutral-700 mx-2">NOMOR INDUK KEPENDUDUKAN</p>
    <input type="text" name="no_ktp"
      class="outline-none focus:ring-0 border-2 border-neutral-400 px-2 py-1 text-lg rounded-md bg-neutral-200/50 focus:text-yellow-500 focus:border-yellow-500 duration-200 focus:bg-yellow-100/25"
      {{ request()->get('edit') != 'true' || empty(request()->get('provinsi')) || empty(request()->get('kota')) || empty(request()->get('kecamatan'))  ? 'disabled' : '' }} value="{{ !empty($detailUser->no_ktp) ? $detailUser->no_ktp : null }}">
  </div>
  <div class="col-start-4 col-end-10 py-1 flex flex-col text-neutral-500 font-medium font-roboto">
    ...
    <input type="text" name="pekerjaan_sampingan"
      class="outline-none focus:ring-0 border-2 border-neutral-400 px-2 py-1 text-lg rounded-md bg-neutral-200/50 focus:text-yellow-500 focus:border-yellow-500 duration-200 focus:bg-yellow-100/25"
      {{ request()->get('edit') != 'true' || empty(request()->get('provinsi')) || empty(request()->get('kota')) || empty(request()->get('kecamatan'))  ? 'disabled' : '' }} value="{{ !empty($detailUser->pekerjaan_sampingan) ? $detailUser->pekerjaan_sampingan : null }}">
  </div>
