<form action="/profile/edit" method="POST" class="relative grid grid-cols-12 p-4 gap-2 w-[50rem] bg-white rounded-lg shadow-md shadow-black/50">
  ...
  <div class="col-span-6 py-1 flex flex-col text-neutral-600 font-medium font-roboto">
    ...
    <input type="text" name="username" required oninvalid="this.setCustomValidity('Semua data harus diisi')" oninput="this.setCustomValidity('')"
      ...
      class="outline-none focus:ring-0 border-2 border-neutral-400 px-2 py-1 text-lg rounded-md placeholder:text-neutral-400 bg-neutral-200/50 focus:text-yellow-500 focus:border-yellow-500 duration-200 focus:bg-yellow-100/25"
