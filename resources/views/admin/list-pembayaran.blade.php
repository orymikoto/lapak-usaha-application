  ...
  <div class="flex flex-col items-center flex-1 my-4 gap-x-4 mx-4">
    ...
    <div class="flex flex-col mx-4 gap-4 items-center">
      ...
      <div class="flex bg-neutral-400 text-neutral-800 w-[30rem] rounded-full overflow-hidden">
        <a href="/admin/daftar-pembayaran?menu=1" class="py-1 flex-1 hover:text-white hover:bg-teal-600 duration-200 text-center font-roboto font-medium {{request()->get('menu') == 1 || request()->get('menu') == null ? 'text-white bg-teal-600' : ''}}">Semua</a>
        <a href="/admin/daftar-pembayaran?menu=2" class="py-1 flex-1 hover:text-white hover:bg-teal-600 duration-200 text-center font-roboto font-medium {{request()->get('menu') == 2 ? 'text-white bg-teal-600' : ''}}">Disetujui</a>
        <a href="/admin/daftar-pembayaran?menu=3" class="py-1 flex-1 hover:text-white hover:bg-teal-600 duration-200 text-center font-roboto font-medium {{request()->get('menu') == 3 ? 'text-white bg-teal-600' : ''}}">Belum Disetujui</a>
      </div>
