...
<head>
  ...
  <script>
    function showUploadFileKontrak() {
...
<body class="antialiased bg-neutral-100 min-h-screen w-full flex flex-col overflow-y-scroll overflow-x-hidden relative">
  <div id="upload_file_kontrak" class="hidden absolute z-20 w-full h-full bg-neutral-600/50 flex items-center justify-center ">
    <form action="/admin/pendanaan/file-kontrak" method="POST" class="p-4 rounded-md flex flex-col items-center bg-white gap-4 relative">
      ...
      <button type="submit" class="px-4 py-1 rounded-md text-white bg-rose-600 hover:text-rose-600 hover:bg-white hover:shadow-md hover:shadow-rose-600 duration-200">Submit</button>
    </form>
  </div>
  <x-navbar />
