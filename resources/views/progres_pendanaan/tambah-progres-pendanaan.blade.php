...
<body class="antialiased bg-neutral-200 min-h-screen w-full flex flex-col overflow-x-hidden ">
  ...
  <div class="flex flex-col items-center gap-2">
    <h1 class="text-yellow-500 font-righteous text-3xl my-4">Tambah Progres Pendanaan</h1>
    <form action="{{ '/progres-pendanaan/tambah/' . request()->route('id_proyek_pendanaan') }}" method="POST" enctype="multipart/form-data"
      ...
      <div class="flex items-center justify-center w-full">
        <label for="dropzone-file"
          ...
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p class="mb-2 text-sm "><span class="font-semibold">Upload Laporan Keuangan</span></p>
            <p class="text-xs ">PDF</p>
          </div>
          <input id="dropzone-file" name="laporan_keuangan" type="file" accept="application/pdf" class="hidden" required />
        </label>
      </div>
      <button type="submit"
